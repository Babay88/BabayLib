...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = (orientation == HORIZONTAL ? controlMaxLength : controlMaxThickness) + hPad;
        int height = (orientation == HORIZONTAL ? controlMaxThickness : controlMaxLength) + vPad;
        //width = Math.max(getMinimumWidth(), width);
        //height = Math.max(getMinimumHeight(), height);
